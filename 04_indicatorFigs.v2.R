...
setwd("/Volumes/GoogleDrive/.shortcut-targets-by-id/1IzmyhjH2hL-DtYsvhTml0HznlsDMF7p6/Pew_ACEC/analyses/output/cmr_sagegrouse_additions/")
...
data <- read.csv(paste0(out.dir, "CMR_Additions_aoi_vs_sample_percentiles_2023-05-02_v1.csv")) %>%
