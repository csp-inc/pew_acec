...
donkey <- load_f("/Volumes/GoogleDrive/.shortcut-targets-by-id/1IzmyhjH2hL-DtYsvhTml0HznlsDMF7p6/Pew_ACEC/maps/DonkeyHills_ID/donkey_hills_noholes.gpkg") %>%
  st_union() %>%
  fill_holes(., 5000)
...
pdf_file <- "/Volumes/GoogleDrive/.shortcut-targets-by-id/1IzmyhjH2hL-DtYsvhTml0HznlsDMF7p6/Pew_ACEC/analyses/output/donkeyhills_id/donkey_intact_west_withscale.pdf"
...
(zoom <- zoom_map_wscale_squishlims(cropped_rast, "viridi", "black", 2473080))
#(zoom <- zoom_map_noscale_squishlims(cropped_rast))


pdf_file <- "/Volumes/GoogleDrive/.shortcut-targets-by-id/1IzmyhjH2hL-DtYsvhTml0HznlsDMF7p6/Pew_ACEC/analyses/output/donkeyhills_id/donkey-intact-zoom-withscale.pdf"
